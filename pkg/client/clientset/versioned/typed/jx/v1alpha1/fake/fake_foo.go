...
var foosResource = schema.GroupVersionResource{Group: "jx", Version: "v1alpha1", Resource: "foos"}

var foosKind = schema.GroupVersionKind{Group: "jx", Version: "v1alpha1", Kind: "Foo"}
